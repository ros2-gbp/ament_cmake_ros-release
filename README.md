...
- upstream repository: https://github.com/ros2/ament_cmake_ros.git
- release repository: https://github.com/ros2-gbp/ament_cmake_ros-release.git
- rosdistro version: `0.14.7-1`
- old version: `0.14.7-1`
- new version: `0.14.8-1`
...
## ament_cmake_ros (rolling) - 0.16.0-1

The packages in the `ament_cmake_ros` repository were released into the `rolling` distro by running `/usr/local/google/home/sloretz/projects/lyrical/env3/bin/bloom-release -r rolling -t rolling ament_cmake_ros` on `Thu, 07 May 2026 18:12:24 -0000`
...
- upstream repository: https://github.com/ros2/ament_cmake_ros.git
- release repository: https://github.com/ros2-gbp/ament_cmake_ros-release.git
- rosdistro version: `0.15.7-2`
- old version: `0.15.7-2`
...
## ament_cmake_ros (lyrical) - 0.15.8-1

The packages in the `ament_cmake_ros` repository were released into the `lyrical` distro by running `/usr/local/google/home/sloretz/projects/lyrical/env3/bin/bloom-release ament_cmake_ros -r lyrical -t lyrical` on `Thu, 30 Apr 2026 16:00:53 -0000`
...
- upstream repository: https://github.com/ros2/ament_cmake_ros.git
- release repository: https://github.com/ros2-gbp/ament_cmake_ros-release.git
- rosdistro version: `0.15.7-3`
- old version: `0.15.7-3`
...
## ament_cmake_ros (rolling) - 0.15.7-1

The packages in the `ament_cmake_ros` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling ament_cmake_ros` on `Mon, 20 Apr 2026 14:20:36 -0000`
...
## ament_cmake_ros (kilted) - 0.14.7-1

The packages in the `ament_cmake_ros` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted ament_cmake_ros` on `Tue, 09 Dec 2025 10:40:26 -0000`
...
- upstream repository: https://github.com/ros2/ament_cmake_ros.git
- release repository: https://github.com/ros2-gbp/ament_cmake_ros-release.git
- rosdistro version: `0.14.6-1`
- old version: `0.14.6-1`
- new version: `0.14.7-1`
...
## ament_cmake_ros (rolling) - 0.15.6-1

The packages in the `ament_cmake_ros` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling ament_cmake_ros` on `Tue, 09 Dec 2025 10:33:29 -0000`
...
## ament_cmake_ros (kilted) - 0.14.6-1

The packages in the `ament_cmake_ros` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted ament_cmake_ros` on `Fri, 28 Nov 2025 17:27:28 -0000`
...
## ament_cmake_ros (rolling) - 0.15.5-1

The packages in the `ament_cmake_ros` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling ament_cmake_ros` on `Fri, 28 Nov 2025 17:21:07 -0000`
...
## ament_cmake_ros (kilted) - 0.14.5-1

The packages in the `ament_cmake_ros` repository were released into the `kilted` distro by running `/home/cottsay/infra_ws/install/bin/bloom-release -r kilted ament_cmake_ros` on `Fri, 31 Oct 2025 06:22:53 -0000`
...
## ament_cmake_ros (rolling) - 0.15.4-1

The packages in the `ament_cmake_ros` repository were released into the `rolling` distro by running `/home/cottsay/infra_ws/install/bin/bloom-release -r rolling ament_cmake_ros` on `Fri, 31 Oct 2025 06:07:47 -0000`
...
## ament_cmake_ros (kilted) - 0.14.4-1

The packages in the `ament_cmake_ros` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted ament_cmake_ros` on `Fri, 17 Oct 2025 09:21:43 -0000`
...
- upstream repository: https://github.com/ros2/ament_cmake_ros.git
- release repository: https://github.com/ros2-gbp/ament_cmake_ros-release.git
- rosdistro version: `0.14.3-2`
- old version: `0.14.3-2`
...
## ament_cmake_ros (rolling) - 0.15.3-1

The packages in the `ament_cmake_ros` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling ament_cmake_ros` on `Fri, 17 Oct 2025 09:16:07 -0000`
